...
function Home({ isLoggedIn }: IProps) {
  ...
  return (
    <Container>
      <Content>
        <Showcase variants={useVariants} initial="init" animate="animate">
          <h1>
            영화와 시리즈를 <br /> 무제한으로.
          </h1>
          <p>해당 페이지는 React로 제작되었습니다.</p>
          <p>
            넷플릭스 클론 사이트이며 회원가입 및 로그인 후 접속하실 수 있습니다.
          </p>
          {isLoggedIn ? (
            <p>
              {" "}
              <span style={{ fontWeight: "600", color: "tomato" }}>
      ...
      <Section>
        <ImgBox>
          <img
            src="https://firebasestorage.googleapis.com/v0/b/myflix-af163.appspot.com/o/img%2Fkids.png?alt=media&token=8c30014c-d540-4e50-aa85-aa8cce120090"
            alt=""
          />
        </ImgBox>
        <TextBox>
